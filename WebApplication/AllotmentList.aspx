<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotmentList.aspx.cs" Inherits="WebApplication.AllotmentList" %>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-details">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <p class="text-center bg-secondary text-white py-2">Allotment List</p>
                            </div>
