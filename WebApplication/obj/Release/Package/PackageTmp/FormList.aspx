<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormList.aspx.cs" Inherits="WebApplication.FormList" %>
...
<head runat="server">
    ...
    <title style="text-transform: uppercase;">register </title>
                    ...
                    <div class="tab-pane fade show active" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-details">
                        ...
                        <div class="row g-4">
                            <div class="col-12 col-md-4">
                                ...
                                <asp:DropDownList ID="drpCategory" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged">
                                </asp:DropDownList>

                            </div>
                            <div class="col-12 col-md-3">
                                <asp:TextBox ID="txtSearchBy" runat="server" CssClass="form-control" placeholder="Search By Name"></asp:TextBox>
                            </div>
                            <div class="col-12 col-md-3">
                            ...
                            <asp:Repeater ID="rpt_Menu" runat="server" OnItemDataBound="rpt_Menu_ItemDataBound">
                                <ItemTemplate>
                                    ...
                                    <div class="col-12">
                                        <p class="text-center bg-secondary text-white py-2">
                                    ...
                                    <div class="col-md-12">
                                        <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" Font-Size="11pt"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="RejectRemark" HeaderText="Reject Reason (If)" />
