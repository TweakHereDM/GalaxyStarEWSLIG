<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Terms-and-Conditions.aspx.cs" Inherits="WebApplication.Terms_and_Conditions" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="body" style="background-color: white !important; padding-top: 100px;">
            <div role="main" class="main">
                <section class="page-header page-header-modern bg-color-grey page-header-lg">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 align-self-center p-static order-2 text-center">
                                <h1 class="font-weight-bold text-dark">Terms and Conditions</h1>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="container py-4">
                    <div class="row">
                        <div class="col">
                            <h3>Last updated on 27 March 2026</h3>

                            <br />
                            <p class="lead">For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean Galaxy Real Mart, whose registered/operational office is S.P. 05, 03 Floor, Rico Industrial Area, Mansarovar, Jaipur – 302020 . "you", “your”, "user", “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>
                        </div>

                        <hr class="solid my-5">
                        <div class="toggle toggle-primary m-0" data-plugin-toggle="">
                            <section class="toggle active">
                                <h4>Your use of the website and/or purchase from us are governed by following Terms and Conditions:</h4>
                                <ul class="terms-list">
                                    ...
                                    <li>You may not create a link to our website from another website or document without GALAXY REALMART's prior written consent.</li>
                            ...
                            <section class="toggle">
                                <h4>Cancellation and Shipping </h4>
                                <p class="p-0 m-0">Last updated on 27 March 2026</p>
                                <p class="p-0 m-0">No cancellations & Refunds are entertained</p>
                                <p class="p-0 m-0">Shipping is not applicable for business.</p>
                            </section>
