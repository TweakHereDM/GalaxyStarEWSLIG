<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalPrint.aspx.cs" Inherits="WebApplicationAdmin.FinalPrint" %>
...
<head runat="server">
    ...
    <title style="text-transform: uppercase;">Final List </title>
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-light bg-light fixed-top ">
                <div class="container text-center">
                    <h1 style="text-align: center"><a href="LotteryReward.aspx">Final Lottery List</a></h1>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <%#Eval("CustomerName") %>
                                                <br />
                                                Father Name/ Husband Name: <%#Eval("RelationName") %>
                                            </ItemTemplate>
