<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="DDReturnPrint.aspx.cs" Inherits="WebApplication.DDReturnPrint" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>DD Return</title>
                ...
                <div class="col-12 text-center pt-3" style="display: flex; justify-content: center; align-items: center; padding-top: 10px !important">
                    <table border="1" style="border-collapse: collapse; text-align: center; width: 80% !important">
                        <tr>
                            ...
                            <th>DD Receiver</th>
                            <th>
                                <asp:Literal ID="ltrIDName" runat="server"></asp:Literal></th>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Literal ID="ltrDDReceiver" runat="server"></asp:Literal></td>
                            <td>
                                <asp:Literal ID="ltrIDValue" runat="server"></asp:Literal></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="col-12 text-center pt-3" style="display: flex; justify-content: center; align-items: center; padding-top: 10px !important">
                    <table border="1" style="border-collapse: collapse; text-align: center; width: 80% !important">
                        <tr>
                            ...
                            <th>DD Receiver</th>
                            <th>
                                <asp:Literal ID="ltrIDName1" runat="server"></asp:Literal></th>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Literal ID="ltrDDReceiver1" runat="server"></asp:Literal></td>
                            <td>
                                <asp:Literal ID="ltrIDValue1" runat="server"></asp:Literal></td>
                        </tr>
                    </table>
                </div>
